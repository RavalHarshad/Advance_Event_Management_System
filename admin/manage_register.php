...
<div class="container-fluid">
    <form action="" id="manage-register">
        ...
        <div class="form-group">
            <label for="" class="control-label">Decoration of Event</label>
            <textarea cols="30" rows = "2" required="" name="event" class="form-control"><?php echo isset($event) ? $address :'' ?></textarea>
        </div>
        <div class="form-group">
