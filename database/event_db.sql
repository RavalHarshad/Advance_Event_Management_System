...
CREATE TABLE `events` (
  ...
  `event` text NOT NULL,
  `description` varchar(255) NOT NULL, -- Fixed by adding length (255)
...
(1, 'Perfect Planner Party', 'ayushimangukiya01@gmali.com', '8469565077', 'Our Team','abc');
...
(1, 'Iscon', 'Sample Address', 'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 300),
(2, 'Rangoli', 'Sample', 'Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 250),
(3, 'Sarover Porticos', 'Sample Address', 'Lorem ipsum dolor sit amet, id has nostro vivendo, id per alii volutpat inciderint? Graece ornatus gubergren te quo, qui at oblique accusamus, id pro eros etiam conceptam! Ullum clita.', 280),
(4, 'Lakhubha Hall', 'Sample only', 'Lorem ipsum dolor sit amet, id has nostro vivendo, id per alii volutpat inciderint? Graece ornatus gubergren te quo, qui at oblique accusamus, id pro eros etiam conceptam! Ullum clita.', 1000);
*/
INSERT INTO venue ('id','venue', 'address', 'description', 'rate') VALUES
(1,'Iscon', 'Near Sundarvas Bungalow, Kaliyabid, Bhavnagar, Gujarat 364002', 'near Sundarvas Bungalow, Kaliyabid, Bhavnagar, Gujarat 364002', 2000.00),
(2,'Rangoli', '8E, National Highway, Vartej, Bhavnagar, Gujarat 364004', '8E, National Highway, Vartej, Bhavnagar, Gujarat 364004', 3000.00),
(3,'Sarover Porticos', 'Opposite, Victoria Park Rd, near Vidhyanagar, ISCON Mega City, Vidhyanagar, Bhavnagar, Gujarat 364002', 'Opposite, Victoria Park Rd, near Vidhyanagar, ISCON Mega City, Vidhyanagar, Bhavnagar, Gujarat 364002', 6000.00),
(4,'Lakhubha Hall', 'GJ SH 6, Ramnagar, Kaliyabid, Bhavnagar, Gujarat 364002', 'GJ SH 6, Ramnagar, Kaliyabid, Bhavnagar, Gujarat 364002', 1500.00);
...
ADD COLUMN `end_duration` DATETIME NULL AFTER `datetime`;
ALTER TABLE venue_booking MODIFY COLUMN id INT AUTO_INCREMENT PRIMARY KEY;
